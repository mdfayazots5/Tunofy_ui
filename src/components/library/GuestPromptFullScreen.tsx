...
interface GuestPromptFullScreenProps {
  title: string;
  description: string;
  onSignInPress: () => void;
}

export const GuestPromptFullScreen: React.FC<GuestPromptFullScreenProps> = ({
  title,
  description,
  onSignInPress,
}) => {
  ...
  return (
    <View style={styles.container}>
      <View style={[styles.iconContainer, { backgroundColor: colors.surface.card }]}>
        <LogIn size={48} color={colors.brand.primary} strokeWidth={1.5} />
      </View>
